...
function Colors:GetColor(Branch, Name)
	if Branch == "Class" then
		if not Spy2.db.profile.Colors[Branch][Name] then
	...
	if not Spy2.db.profile.Colors[Branch][Name].a then
		Spy2.db.profile.Colors[Branch][Name].a = 1
	end
	return Spy2.db.profile.Colors[Branch][Name]
end

function Colors:SetColor(Branch, Name, c)
	if type(Spy2.db.profile.Colors[Branch][Name]) ~= "table" then
		Spy2.db.profile.Colors[Branch][Name] = {}
	end
	Spy2.db.profile.Colors[Branch][Name].r = c.r
	Spy2.db.profile.Colors[Branch][Name].g = c.g
	Spy2.db.profile.Colors[Branch][Name].b = c.b

	Spy2.db.profile.Colors[Branch][Name].a = c.a
